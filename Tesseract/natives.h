...
static void CHANGE_PLAYER_PED(Ped pIndex, Ped newPed, BOOL p2, BOOL p3) { invoke<Void>(0xBE515485, pIndex, newPed, p2, p3); } // 0xBE515485
...
static Any GET_ENTITY_ANIM_CURRENT_TIME(Any p0, char* p1, char* p2) { return invoke<Any>(0x83943F41, p0, p1, p2); } // 0x83943F41
...
static BOOL IS_ENTITY_PLAYING_ANIM(Any p0, char* p1, char* p2, Any p3) { return invoke<BOOL>(0x0D130D34, p0, p1, p2, p3); } // 0x0D130D34
...
static void SET_PED_MOVEMENT_CLIPSET(Ped p0, const char* p1, Any p2) { invoke<Void>(0xA817CDEB, p0, p1, p2); } // 0xA817CDEB
...
static BOOL GET_CLOSEST_PED(float x, float y, float z, float Radius, BOOL p4, BOOL p5, int *handle, BOOL p7, BOOL p8, int p9) { return invoke<BOOL>(0x8F6C1F55, x, y, z, Radius, p4, p5, handle, p7, p8, p9); } // 0x8F6C1F55
...
static void CREATE_NM_MESSAGE(bool startImmediately, int messageID) { invoke<Void>(0x1CFBFD4B, startImmediately, messageID); } // 0x1CFBFD4B
static void GIVE_PED_NM_MESSAGE(Ped p0) { invoke<Void>(0x737C3689, p0); } // 0x737C3689
...
static void GET_VEHICLE_CUSTOM_SECONDARY_COLOUR(Any p0, int* r, int* g, int* b) { invoke<Void>(0x3FF247A2, p0, r, g, b); } // 0x3FF247A2
...
static void TASK_START_SCENARIO_IN_PLACE(Any p0, const char* p1, Any p2, Any p3) { invoke<Void>(0xE50D6DDE, p0, p1, p2, p3); } // 0xE50D6DDE
...
static void TASK_SYNCHRONIZED_SCENE(Any p0, Any p1, char* p2, char* p3, Any p4, Any p5, Any p6, Any p7, Any p8, Any p9) { invoke<Void>(0x4F217E7B, p0, p1, p2, p3, p4, p5, p6, p7, p8, p9); } // 0x4F217E7B
...
static void SET_WEATHER_TYPE_PERSIST(const char* WeatherType) { invoke<Void>(0xC6C04C75, WeatherType); } // 0xC6C04C75
static void SET_WEATHER_TYPE_NOW_PERSIST(const char* WeatherType) { invoke<Void>(0xC869FE97, WeatherType); } // 0xC869FE97
static void SET_WEATHER_TYPE_NOW(const char* WeatherType) { invoke<Void>(0x361E9EAC, WeatherType); } // 0x361E9EAC
static void _SET_WEATHER_TYPE_OVER_TIME(const char* WeatherType, float Time) { invoke<Void>(0x386F0D25, WeatherType, Time); } // 0x386F0D25
...
static void SET_OVERRIDE_WEATHER(const char* WeatherType) { invoke<Void>(0xD9082BB5, WeatherType); } // 0xD9082BB5
...
static void GET_MODEL_DIMENSIONS(Entity Entity, Vector3* Minimum, Vector3* Maximum) { invoke<Void>(0x91ABB8E0, Entity, Minimum, Maximum); } // 0x91ABB8E0
...
static BOOL IS_STRING_NULL_OR_EMPTY(char* p0) { return invoke<BOOL>(0x42E9F2CA, p0); } // 0x42E9F2CA
...
static Any REQUEST_AMBIENT_AUDIO_BANK(char* p0, Any p1) { return invoke<Any>(0x23C88BC7, p0, p1); } // 0x23C88BC7
...
static void PLAY_SOUND_FROM_COORD(Any p0, char* p1, Any p2, Any p3, Any p4, Any p5, Any p6, Any p7, Any p8) { invoke<Void>(0xCAD3E2D5, p0, p1, p2, p3, p4, p5, p6, p7, p8); } // 0xCAD3E2D5
...
static Any START_AUDIO_SCENE(char *p0) { return invoke<Any>(0xE48D757B, p0); } // 0xE48D757B
...
static void SET_AUDIO_FLAG(char* flag, Any p1) { invoke<Void>(0x1C09C9E0, flag, p1); } // 0x1C09C9E0
...
static Any _0x09337863(Any p0, Any p1) { return invoke<Any>(0x09337863, p0, p1); } // 0x09337863
																				   //static Vector3 GET_PED_LAST_WEAPON_IMPACT_COORD(Ped Handle) { return invoke<Vector3>(0x9B266079, Handle); } // 0x9B266079
...
static void REQUEST_CLIP_SET(const char* p0) { invoke<Void>(0x546C627A, p0); } // 0x546C627A
static BOOL HAS_CLIP_SET_LOADED(const char* p0) { return invoke<BOOL>(0x230D5455, p0); } // 0x230D5455
...
static void REQUEST_PTFX_ASSET_BY_NAME(char* FX) { invoke<Void>(0xCFEA19A9, FX); } // 0xCFEA19A9
static BOOL HAS_PTFX_ASSET_LOADED_BY_NAME(char* FX) { return invoke<BOOL>(0x9ACC6446, FX); } // 0x9ACC6446
...
static void _0x574EE85C(const char* p0) { invoke<Void>(0x574EE85C, p0); } // 0x574EE85C
...
static void SET_TEXT_ENTRY(char* text) { invoke<Void>(0x3E35563E, text); } // 0x3E35563E
static void DRAW_TEXT(float x, float y) { invoke<Void>(0x6F8350CE, x, y); } // 0x6F8350CE
...
static void _0xB245FC10(char* p0) { invoke<Void>(0xB245FC10, p0); } // 0xB245FC10
...
static void ADD_TEXT_COMPONENT_INTEGER(int num) { invoke<Void>(0xFE272A57, num); } // 0xFE272A57
static void ADD_TEXT_COMPONENT_FLOAT(float num, int DecimalPlaces) { invoke<Void>(0x24D78013, num, DecimalPlaces); } // 0x24D78013
...
static void ADD_TEXT_COMPONENT_STRING(const char* text) { invoke<Void>(0x27A244D8, text); } // 0x27A244D8
...
static Any START_PARTICLE_FX_NON_LOOPED_AT_COORD(char* p0, Any p1, Any p2, Any p3, Any p4, Any p5, Any p6, Any p7, Any p8, Any p9, Any p10) { return invoke<Any>(0xDD79D679, p0, p1, p2, p3, p4, p5, p6, p7, p8, p9, p10); } // 0xDD79D679
...
static Any START_PARTICLE_FX_NON_LOOPED_ON_ENTITY(char* p0, Any p1, Any p2, Any p3, Any p4, Any p5, Any p6, Any p7, Any p8, Any p9, Any p10, Any p11) { return invoke<Any>(0x9604DAD4, p0, p1, p2, p3, p4, p5, p6, p7, p8, p9, p10, p11); } // 0x9604DAD4
...
static void SET_TIMECYCLE_MODIFIER(const char* CycleType) { invoke<Void>(0xA81F3638, CycleType); } // 0xA81F3638
...
static Any REQUEST_SCALEFORM_MOVIE(const char* p0) { return invoke<Any>(0xC67E3DCB, p0); } // 0xC67E3DCB
...
static void _0x3AC9CB55(const char* p0) { invoke<Void>(0x3AC9CB55, p0); } // 0x3AC9CB55
...
static Any NETWORK_GET_HOST_OF_SCRIPT(const char* p0, Any p1, Any p2) { return invoke<Any>(0x9C95D0BB, p0, p1, p2); } // 0x9C95D0BB
...
static Any _0x8A04E1FE(char* p0, char* p1) { return invoke<Any>(0x8A04E1FE, p0, p1); } // 0x8A04E1FE
...
static int DECOR_GET_INT(Entity p0, char* p1) { return invoke<Any>(0xDDDE59B5, p0, p1); } // 0xDDDE59B5
static Any _0x74EF9C40(Any p0, Any p1) { return invoke<Any>(0x74EF9C40, p0, p1); } // 0x74EF9C40
static Any DECOR_REMOVE(Any p0, char* p1) { return invoke<Any>(0xE0E2640B, p0, p1); } // 0xE0E2640B
static void DECOR_REGISTER(char* p0, int p1) { invoke<Void>(0x68BD42A9, p0, p1); } // 0x68BD42A9
static Any DECOR_IS_REGISTERED_AS_TYPE(char* p0, int p1) { return invoke<Any>(0x7CF0971D, p0, p1); } // 0x7CF0971D
